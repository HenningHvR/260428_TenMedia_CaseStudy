                ...
                <div class="p-6 text-gray-900">
                    ...
                    @if ($companies->isEmpty())
                        <div class="mb-4 p-4 bg-red-100 text-red-800 rounded">
                            Du kannst noch kein JobPosting erstellen, weil Deinem User noch keine Firma zugeordnet ist.
                        </div>
                    @endif

                    @if ($categories->isEmpty())
                        <div class="mb-4 p-4 bg-red-100 text-red-800 rounded">
                            Du kannst noch kein JobPosting erstellen, weil noch keine Kategorie angelegt wurde.
                        </div>
                    @endif
                    ...
                    <form method="POST" action="{{ route('job-postings.store') }}">
                        ...
                        <div class="mb-4">
                            ...
                            <input
                                ...
                                placeholder="z. B. Vollzeit, Teilzeit, Praktikum"
                                class="block mt-1 w-full border-gray-300 rounded-md shadow-sm"
                            >
                        ...
                        <div class="flex items-center gap-4">
                            <button
                                ...
                                @disabled($companies->isEmpty() || $categories->isEmpty())
                            >
                                Speichern
                            </button>
